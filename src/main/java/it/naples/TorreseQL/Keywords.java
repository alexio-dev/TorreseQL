...
public class Keywords {
    ...
    public final static String[] INSERT = {"NGAS", "IND"};

    public static final String[] DELETE = {"LIEV", "A", "MIEZZ"};

    public static final String[] JOIN = {"AMMESC", "TUTT", "COS"};

    public static final String[] FROM = {"MMIEZ", "A"};

    public final static String[] ALL = {"TUTT", "COS"};

    public final static String WHERE = "ADDO";

    public final static String[] BEGIN = {"ITTAMM", "I", "MMAN"};

    public final static String[] COMMIT = {"JAMMUNCENN", "A", "CAS"};
    ...
    public final static String[] ISNT = {"NUN", "APPARTEN"};

    public final static String VALUES = "CHEST";

    public final static String SET = "APPARAMM";

    public final static List<String> OPERATORS = Arrays.asList(">", "<", "=", "!=", "<>", ">=", "<=", Keywords.IS, Keywords.ISNT[0]);
